...
class ORM_MPTT_Core extends ORM_Tree_Core {
  ...
  public function add_child(ORM_MPTT $model) {
    ...
    $this->db->query("UPDATE ".$this->table_name." SET ".$this->left_column."="
      .$this->left_column."+2 WHERE ".$this->left_column." > ".$this->object[$this->right_column]);
    $this->db->query("UPDATE ".$this->table_name." SET ".$this->right_column."="
  ...
  public function delete($id = NULL) {
    ...
    // adjust left and right values
    $this->db->query('UPDATE '.$this->table_name.' SET '.$this->left_column.'='
      .$this->left_column.'-'.$move.' WHERE '.$this->left_column.' > '
      .$this->object[$this->right_column]);
    $this->db->query('UPDATE '.$this->table_name.' SET '.$this->right_column.'='
      .$this->right_column.'-'.$move.' WHERE '.$this->right_column.' > '
      .$this->object[$this->right_column]);
