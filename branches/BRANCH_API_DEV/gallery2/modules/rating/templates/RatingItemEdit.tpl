...
<div class="gbBlock">
	...
	{g->text text="This will enable or disable ratings for this album.  You can use permissions to allow viewing or adding ratings for specific users or groups."}
	</p>
