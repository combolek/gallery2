...
# SchemaColumns
CREATE TABLE DB_TABLE_PREFIXSchemaColumns(
 DB_COLUMN_PREFIXname varchar(128) NOT NULL,
 DB_COLUMN_PREFIXcolumn varchar(128) NOT NULL,
 DB_COLUMN_PREFIXtype int(11) NOT NULL
) TYPE=DB_TABLE_TYPE;
...
CREATE TABLE DB_TABLE_PREFIXSchemaColumns(
 DB_COLUMN_PREFIXname VARCHAR(128) NOT NULL,
 DB_COLUMN_PREFIXcolumn VARCHAR(128) NOT NULL,
 DB_COLUMN_PREFIXtype INTEGER NOT NULL);
...
CREATE TABLE DB_TABLE_PREFIXSchemaColumns(
 DB_COLUMN_PREFIXname VARCHAR2(128) NOT NULL,
 DB_COLUMN_PREFIXcolumn VARCHAR2(128) NOT NULL,
 DB_COLUMN_PREFIXtype INTEGER NOT NULL);
