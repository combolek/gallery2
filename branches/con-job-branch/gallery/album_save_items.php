...
<head>
  ...
  function showProgress() {
    ...
    //                 'height=150,width=350,location=no,scrollbars=no,menubars=no,toolbars=no,resizabl
e=yes');
    document.urlupload_form.doit.value=\"Don't Click Me Again!!! Upload in Progress!!!\";
  }
...
<body onLoad='opener.hideProgress();'>
...
if (count($image_tags)) {
?>
<?= makeFormIntro("album_save_items.php", 
...
<?
	...
	foreach ( $image_tags as $image_src) {
		print "<tr><td><input type=checkbox name=\"urls_or_path[]\" value=\"$image_src\" checked>$image_src</td></tr>\n";
	}
?>
</table>
<input type=hidden name="setCaption" value="<?=$setCaption?>">
<input type=hidden name="return" value="<?=$return?>">
<input type=submit name="doit" value="Add These Items" onClick="showProgress()">
</form>
<?
...
?>
<hr size="1">
All Done! Click <a href="<?=$return?>">here</a> to return to the album.<br>
<hr size="1">
<?
}
?>
