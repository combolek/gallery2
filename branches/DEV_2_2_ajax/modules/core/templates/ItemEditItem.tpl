...
<div class="gbBlock">
  {if $ItemEditItem.can.changePathComponent}
    <div>
      <h2> {g->text text="Name"} <span class="giSubtitle"> {g->text text="(required)"} </span> </h2>
	...
	{/capture}
      ...
      <div class="giError" id="{"errorPathComponentMissing"|elementId}"{if empty($form.error.pathComponent.missing)} style="display: none"{/if}>
	...
	{/capture}
      ...
      <div class="giError" id="{"errorPathComponentCollision"|elementId}"{if empty($form.error.pathComponent.collision)} style="display: none"{/if}>
  ...
  <div>
    ...
    <div class="giError" id="{"errorMissingRootTitle"|elementId}"{if empty($form.error.title.missingRootTitle)} style="display: none"{/if}>
...
<div class="gbBlock">
  ...
  <div class="giError" id="{"errorOriginationTimestampInvalid"|elementId}"{if empty($form.error.originationTimestamp.invalid)} style="display: none"{/if}>
...
{if $ItemEditItem.can.editThumbnail}
  <div class="gbBlock">
    ...
    <div class="giError" id="{"errorThumbnailSizeInvalid"|elementId}"{if empty($form.error.thumbnail.size.invalid)} style="display: none"{/if}>
    ...
    <div class="giError" id="{"errorThumbnailCreate"|elementId}"{if empty($form.error.thumbnail.create)} style="display: none"{/if}>
