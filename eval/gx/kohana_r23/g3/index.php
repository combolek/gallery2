...
// ----------------------------------------------------------------------------
// $Id: index.php 3531 2008-10-05 14:42:55Z Shadowhand $
//
...
define('APP_MODULE_PATH', str_replace('\\', '/', realpath($kohana_application_modules)).'/');
define('APP_THEME_PATH', str_replace('\\', '/', realpath($kohana_application_themes)).'/');
